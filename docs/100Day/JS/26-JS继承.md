...
## 参考
- [JavaScript常见的六种继承方式](https://segmentfault.com/a/1190000016708006 "JavaScript常见的六种继承方式")
- [JS继承的几种方式](https://juejin.im/post/5b654e88f265da0f4a4e914c "JS继承的几种方式")
- [JavaScript深入之继承的多种方式和优缺点](https://github.com/mqyqingfeng/Blog/issues/16 "JavaScript深入之继承的多种方式和优缺点")
- [ECMAScript6入门之 Class的继承](https://es6.ruanyifeng.com/#docs/class-extends "ECMAScript6入门之 Class的继承")